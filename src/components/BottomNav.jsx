...
export default function BottomNav() {
  const nav = (
    <div
      className="fixed z-[2147483647] inset-x-0 bottom-0"
      style={{ background: "var(--nav-bg)", opacity: 1, pointerEvents: "auto" }}
    >
      <div
        className="zf-bottom-nav max-w-sm mx-auto flex items-center justify-between px-6 py-3 border-t border-[var(--line)] shadow-[0_-6px_18px_rgba(0,0,0,0.08)]"
